  ...
  <div class="form">
   ...
   <span style="color:green;"><?php echo $success; ?></span>
    <form action="" method="post">
	  ...
	  <div ><a href="http://localhost/food/admin/" style="color:#f30;"> admin login</a></div>
	  <li class="nav-item"> <a class="nav-link active" href="reg_login.php">rest_login <span class="sr-only"></span></a> </li>                           
    </form>
  </div>
