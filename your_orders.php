        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food-picky-logo.png" widtgh='250' height='50' alt=""> </a>
        ...
        <div class="page-wrapper">
            ...
            <section class="restaurants-page">
                <div class="container">
                    ...
                    <button onclick="location.href='checkout.php'" type="button" class="btn theme-btn btn-lg">Order Now</button>
